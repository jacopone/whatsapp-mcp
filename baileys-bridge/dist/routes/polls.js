 ...
 */
export function registerPollRoutes(router, getSock) {
    // POST /polls/create-v2 - Create single-choice poll
    router.post('/polls/create-v2', async (req, res) => {
    ...
    router.post('/polls/create-v3', async (req, res) => {
    ...
    router.post('/polls/:message_id/vote', async (req, res) => {
    ...
    router.get('/polls/:message_id/results', async (req, res) => {
        const { message_id } = req.params;
